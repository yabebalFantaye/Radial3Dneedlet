pro synball_sincos,an_sin,an_cos,cl,ball,almn=almn,almr=almr,beam=beam,lmax=lmax_in,nmax=nmax_in,nshell=nshell,nside=nside,$
...
almn=dcomplexarr(1,lmax+1,lmax+1,nmax+1,2)

for nn=0,nmax do begin
   for ll=0,lmax do begin
      almn[0,ll,0:lmax,nn,0]=alm[0,ll,0:lmax]*an_sin[nn]
      almn[0,ll,0:lmax,nn,1]=alm[0,ll,0:lmax]*an_cos[nn]
   endfor
endfor
