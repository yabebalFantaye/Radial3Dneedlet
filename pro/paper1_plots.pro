...
an_sim=dblarr(nmax+1)
cl_sim[2:lmax_sim]=clmm[1:lmax_sim-1]
an_sim[0:nmax_sim]=  anmm[0:nmax_sim] 
...
synball,an_sim,cl_sim,ball_sim,almn=almn_sim,lmax=lmax_sim,nmax=nmax_sim,nshell=nshell,nside=nside,almr=almr_sim
